/******/ (() => { // webpackBootstrap
/*!******************************************************!*\
  !*** ./src/blocks/block-department-services/view.js ***!
  \******************************************************/
/**
...
document.querySelectorAll('.dept-services__item-header').forEach(button => {
  button.addEventListener('click', () => {
    ...
    item.closest('.dept-services__list').querySelectorAll('.dept-services__item').forEach(el => el.classList.remove('is-active'));
